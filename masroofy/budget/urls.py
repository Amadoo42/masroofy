...
from .views import HistoryView, SetupView, AppLoginView, AppSignupView, DashboardView, TransactionDeleteView, TransactionEditView, SettingsView, NotificationReadView
